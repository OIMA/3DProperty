                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 column">
                            <div class="row clearfix">
                                <div class="col-lg-8 column" id="canvasX3D">
                                    <div class="tabbable" id="tabs-435131">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li id="tabPromotor">
                                                <a href="#promotor" data-toggle="tab">Promotor</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                                ...
                                                <div id="canvas">
                                                    ...
                                                    <x3d id='x3domCanvas' showStat='false' showLog='false' x='0px' y='0px'>
                                                        <scene DEF='scene'>
                                                            ...
                                                            <inline 
                                                                url="<%=request.getContextPath()%>/x3d/2.x3d">
                                                            </inline>
                                                        </scene>
                                                    </x3d>
                                                    <div>
                                            ...
                                            <div class="tab-pane" id="images">
                                                ...
                                                <div id="gallery">
                                                    <div id="panel">
                                                        <img class="image" id="largeImage" src="images/image_01_large.jpg" />
                                                        <!--<div id="description">1st image description</div>-->
                                                    </div>

                                                    <div id="thumbs">
                                                        <img class="tmb" src="images/image_01_thumb.jpg" alt="1st image description" />
                                                        <img class="tmb" src="images/image_02_thumb.jpg" alt="2nd image description" />
                                                        <img class="tmb" src="images/image_03_thumb.jpg" alt="3rd image description" />
                                                        <img class="tmb" src="images/image_04_thumb.jpg" alt="4th image description" />
                                                        <img class="tmb" src="images/image_05_thumb.jpg" alt="5th image description" />
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-4 column" id="divImagenes">
                                ...
                                <div class="col-md-4 column" id="divPromotor">
                                    <h1>Contacto al promotor</h1>
                                    <div class="media well">
                                        <!--                                        <a href="#" class="pull-left">
                                                                                    <img src="<%=request.getContextPath()%>/images/icons/leftClick.png" class="media-object" alt=''  height="80" width="70"/>
                                                                                </a>
